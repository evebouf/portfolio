        ...
        <div className="terminal-content">
          ...
          {phase >= 3 && (
            <div className="main-session">
              ...
              <div className="output">i design and write software at <a href="https://www.ycombinator.com/" target="_blank" rel="noopener noreferrer" className="terminal-link"> <img src="/yc.png" alt="YC" className="yc-logo" /> YC</a></div>
